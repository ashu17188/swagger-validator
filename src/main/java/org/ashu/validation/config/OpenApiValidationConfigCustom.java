...
//@EnableCaching
//@Configuration
public class OpenApiValidationConfigCustom implements WebMvcConfigurer{
	...
	@Autowired
	public OpenApiValidationConfigCustom(final List<OpenApiSpecsSupplier> openApiSpecsSuppliers, final List<GenericRequestValidator> genericRequestValidators) throws IOException {
