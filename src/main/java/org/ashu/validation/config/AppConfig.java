		...
		simpleModule.addDeserializer(OffsetDateTime.class, new JsonDeserializer<>() {
			...
			public OffsetDateTime deserialize(JsonParser jsonParser, DeserializationContext ctxt)
				...
				DateTimeFormatter formatter = new java.time.format.DateTimeFormatterBuilder()
						.append(DateTimeFormatter.BASIC_ISO_DATE.ISO_DATE).appendOptional(DateTimeFormatter.ofPattern("'T'"))
						.appendOptional(DateTimeFormatter.ofPattern("HH:mm:ss")).appendOptional(DateTimeFormatter.ofPattern(".SSS"))
						.appendOptional(DateTimeFormatter.ofPattern("HH:mm:ss")).toFormatter();
				try {
